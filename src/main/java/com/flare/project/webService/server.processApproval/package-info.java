...
@jakarta.xml.bind.annotation.XmlSchema(namespace = "http://localhost:7070/soap/processApproval", elementFormDefault = jakarta.xml.bind.annotation.XmlNsForm.QUALIFIED)
