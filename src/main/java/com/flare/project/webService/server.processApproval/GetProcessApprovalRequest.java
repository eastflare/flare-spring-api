...
@XmlRootElement(name = "getProcessApprovalRequest")
public class GetProcessApprovalRequest {
    ...
    public String toString() {
        return "GetProcessApprovalRequest{" +
                "apitype='" + apitype + '\'' +
                ", systemid='" + systemid + '\'' +
                ", appkey01='" + appkey01 + '\'' +
                ", appkey02='" + appkey02 + '\'' +
                ...
                ", commenteuckr='" + commenteuckr + '\'' +
                ", result='" + result + '\'' +
                ", apprdate='" + apprdate + '\'' +
                ", nextapprtype='" + nextapprtype + '\'' +
                ", nextapproverorder='" + nextapproverorder + '\'' +
